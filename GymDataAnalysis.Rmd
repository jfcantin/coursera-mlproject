...
Multiple classification models were tried and the random forest model performed the best.
...
The in sample estimate of error rate calculated for the final model of the random forest model with 50 trees is 1.27% which translate into a 98.73% accuracy for the classification.
...
Using the test set we calculated an accuracy of 98.96% which translate into an out of sample error rate of 1.04%. So it seems that the model was not over fitting the data.
